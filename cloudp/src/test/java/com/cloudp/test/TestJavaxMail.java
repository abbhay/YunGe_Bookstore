...
public class TestJavaxMail {
    ...
    //发件人邮箱
    private static String myEmailAccount = "3473767352@qq.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "fmnwwnzyuxavdahi";
...
//连接自己的邮箱账户
    ...
    public static void main(String[] args) throws Exception{
        new TestJavaxMail().sendEmail("358737741@qq.com","欢迎注册云鸽！","<h1 algin='center'>您的验证码是xxxxx</h1>");
    }
}
